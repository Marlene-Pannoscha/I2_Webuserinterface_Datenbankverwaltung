...
Use-Case: exterene Informationsabfrage (UC09)| Nein | Micht unsere Aufgabe |
Use-Case: Möglichkeit zum Bearbeiten und Anlegen von Fakultäten (UC10)| Ja | Nur Anlegen möglich |
|===
...
Land hinzufügen | Nein | Speichern funktioniert nicht |
...
Der Software-Stand wird am 30.06.2023 durch ... auf den Server übertragen.
