...
Um unser Projekt erfolgreich durchzuführen, nutzen wir den Open Unified Process (OpenUP). Aufgaben werden hierbei in Iterationen bearbeitet, welche jeweils 2 bis 3 Wochen andauern. Die zu erldeigenden Aufgaben werden als Issues festgehalten und dem jeweiligen Gruppenmitglied zugewiesen.
