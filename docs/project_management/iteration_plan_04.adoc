...
| Reiter Berichte implementieren | hoch | 6 | laufend | / | 1 | ausstehend | 5 | /
| Entwicklerdokumentation (Design) | hoch | 5 | laufend | / | 1 | ausstehend | 4 | /
| Entwicklerdokumentation (Software) | hoch | 5 | laufend | / | | | |
| Standards in Dokumentation festhalten (Belegdokumentation) | hoch | 5 | laufend | / | 1 | Marlene Pannoscha  | 3 | /
| Anlegen neuer Partnerhochschulen (Bearbeitung Ansprechperson Fenster) | hoch | 6 | laufend | / | 1 | ausstehen| 2 | /
