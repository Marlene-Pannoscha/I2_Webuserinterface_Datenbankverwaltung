...
| Filterfunktionen (Sortierungsreiter entfernen) | hoch | 8 | laufend | / | 1 | Dilara Eichler, Alessandra Russ  | 3 | /
| Reiter Berichte implementieren | hoch | 6 | laufend | / | 1 | Alessandra Russ | 5 | /
...
| Anlegen neuer Partnerhochschulen (Bearbeitung Ansprechperson Fenster) | hoch | 6 | laufend | / | 1 | Dilara Eichler | 2 | /
|Button Land hinzufügen implementieren| hoch | 5 | laufend | / | 1 | ausstehend | 4 | /  Deployment Engineer bestimmen | hoch | 1 | laufend | / |
