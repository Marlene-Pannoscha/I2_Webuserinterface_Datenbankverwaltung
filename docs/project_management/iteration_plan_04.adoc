...
|===
| Meilenstein | Datum
| Beginn der Iteration | 03.05.2023
| Abnahme durch SI |
| Ende der Iteration | 17.05.2023
|===
...
* Möglichkeiten zum Bearbeiten und Anlegen der Fakultäten
...
| Filterfunktionen | hoch | 8 | laufend | / | 1 | Dilara Eichler, Alessandra Russ  | 3 | /
| Möglichkeiten zum Bearbeiten und Anlegen der Fakultäten | hoch | 6 | laufend | / | 1 | ausstehend | 5 | /
| Entwicklerdokumentation | hoch | 6 | laufend | / | 1 | ausstehend | 4 | /
| Standards in Dokumentation festhalten  | hoch | 5 | laufend | / | 1 | ausstehend  | 3 | /
| Essence Kernel Navigator | hoch | 6 | laufend | / | 1 | Marlene Pannoscha | 2 | /
|Backend Überarbeitung | hoch | 5 | laufend | / | 1 | ausstehend | 4 | /
