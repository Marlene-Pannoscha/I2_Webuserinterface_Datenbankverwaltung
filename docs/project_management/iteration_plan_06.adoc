...
| x | x | x | x | x | x | x | x | x
Berichte erzeugen (verschiedene Typen) Robert Pfund | Projektbericht Dokumentation Kevin Freund, Marlene Pannoscha |
Löschen von Daten mit Passwortabfrage Alessansra Ruff | Lizenzen bestimmen | Alessandra Ruff | Anwenderdokumentation für Mitarbeiten (in Video Form)
|===
