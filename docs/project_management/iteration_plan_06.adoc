...
Löschen von Daten mit Passwortabfrage |hoch | 6 |fertig | / |  1 | Alessansra Ruff | | /|
Lizenzen bestimmen |mittel | 4 | fertig | / | 1 |  Alessandra Ruff | | / |
Anwenderdokumentation für Mitarbeiten (in Video Form) | hoch |5 | laufend |/ | 1 | Marlene Pannoscha | | / |
Projektbericht Dokumentation | hoch| 8 | laufend | wird auf Github in kleine Issues unterteielt und dem ganzen Team zugewiesen | 2 | Team | | / |
