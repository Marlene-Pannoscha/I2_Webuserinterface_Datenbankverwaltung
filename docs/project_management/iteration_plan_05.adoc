...
| Mentoren Suchleiste und Filtern nach Fakultät| x | x | x | x | x | x | x | x |
Anlegen neuer Universitäten(Partnerhochschulen) | Dilara Eichler | Snapshot der Datenbank exportieren und einführen | Kevin | Freund
Layout der Pop- Up Fenster vereinheitlichen Dilara, Alesasandra, Kevin | Berichte anzeigen und exportieren  Robert Pfund | Abnahmeprotokoll | Schulung | Projektbericht anfangen
|===
...
| Speichen Mentoren und Partnerhochschulen Dilara und Alesssandra| x | x |
Verträge: Hochschulvereinbarung falsche Anzahl bzw doppelte Auflistung | Abbrechen Button bei Verträge
|===
