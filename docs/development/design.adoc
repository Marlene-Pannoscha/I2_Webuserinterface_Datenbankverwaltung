...
|new_tbl_institute |Partnerhochschule, International office |auf Informationsfrontend: Anlegen, Ändern, Verstecken (auf Informationsfrontend)

|new_tbl_partnership |Zuweisung eines Partnerschaftstypes (1:n) zu new_tbl_institute |Anlegen (implizit mit Vertrag)

|new_tbl_partnership_type |Definition unterschiedliche Abkommenstypen |-

|new_tbl_mobility_agreement |Vertragsinformationen, verweist auf den Mentor und den Vertragstyp / Hochschule in _tbl_partnership_ |Anlegen, Ändern, Deaktivieren

|new_tbl_mobility_agreement_x_course |optionale Beschränkungen der Anzahl der Incoming / Outgoing pro Vertrag und Studiengang
