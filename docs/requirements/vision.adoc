...
| Partnerhochschulen löschen | xx | Zum Entfernen einer Partnerhochschule oder derer Datenattribute im Verwaltungsfrontend | xSommersemester 2023
...
| lediglch nutzbar im HTW-Netz durch IP-Sperre | xx | Sommersemester 2023
