...
| eine erfolgreiche Lösung wäre [ie Aktualisierung des Bestehenden Web-User-Interfaces, sowie eine Ergänzung von intuitiven Funktionen]
|===
...
[cols="1,3"]
|===
| Für | [as Akademische Auslandsamt der HTW Dresden sowie betroffene Externe (z.B. Partnerhochschulen o.Ä.)]
...
| Im Gegensatz zum | [Interface-Prototypen] ist
| unser Produkt | [intuitiv und einfach zu bedienen]
|===
...
| Erweiterte Infos | 7 | Anzeige detailierter Infos einzelner Universitäten | Sommersemester 2023
