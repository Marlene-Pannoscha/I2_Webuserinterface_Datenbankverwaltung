...
| Anlegen neuer Universitäten | 7 | Zum Einfügen neuer Verträge im Verwaltungsfrontend | Sommersemester 2023
| Erzeugen von Berichten | 10 | Zur Ausgabe verschiedener gesammelter Daten | Sommersemester 2023
