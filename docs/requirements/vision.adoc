...
| 
| - Koordinierung der Pläne, Erstellung von Zeitplänen,
 Ansprechpartner, für die Behebung von Problemen verantwortlich
| Anwender 
| Mitarbeiter der Stabstelle Internationales
|
| Eigentümer
|
|
...
| Login System | xx | gewährt zulässigen Nutzern authorisierten Zugang zur Verwaltung | Sommersemester 2023
| Partnerhochschulen anlegen | xx | Zum Einfügen neuer Partnerhochschulen und der Verträge im Verwaltungsfrontend | Sommersemester 2023
| Partnerhochschulen bearbeiten | xx | Zum Verändern eines oder mehrerer bereits bestehenden Hochschulattribute im Verwaltungsfrontend |Sommersemester 2023
| Partnerhochschulen löschen | xx | Zum Entfernen einer Partnerhochschule oder derer Datenattribute im Verwaltungsfrontend | Sommersemester 2023
| Erweiterte Infos | xx | Anzeige detailierter Infos einzelner Universitäten | Sommersemester 2023
| Modifizieren von Bestandsdaten | xx | Zum Bearbeiten einer oder mehrerer Datensätze im Verwaltungsfrontend | Sommersemester 2023
| Anzeige von Austauschstudenten | xx | zur Ausgabe von Informationen über Austauschstudenten | Sommersemester 2023
| Bearbeiten von Austauschstudenten | xx | zur Pflege von Statistiken | Sommersemester 2023
| Anzeige von Statistiken | xx | zur Ausgabe verschiedener gesammelter Daten | Sommersemester 2023
| Filterfunktion | xx | aussortieren nicht gesuchter Einträge | Sommersemester 2023
| Manuelle Suchfunktion | xx | Ermögtlicht die manuelle Suche per Texteingabe | Sommersemester 2023
|===
...
| saubere und ausführliche Entwicklerdokumentation | xx | Sommersemester 2023
| saubere und ausführliche Nutzerdokumentation für die Stabstelle | xx | Sommersemester 2023
| Verbesserung des jetzigen Prototyps bzw. dessen Funktionen | xx | Sommersemester 2023
| komprimiert (nicht zu viel offene, unnötige Fenster) | xx | Sommersemester 2023
| übersichtlich | xx | Sommersemester 2023
| MS-Access ähnliches Schema | xx | Sommersemester 2023
| in jedem zeitgemäßem Browser nutzbar | xx | Sommersemester 2023
| benutzerfreundliche Handhabung | xx | Sommersemester 2023
| lediglich nutzbar im HTW-Netz durch IP-Sperre | xx | Sommersemester 2023
| personenbezogene Daten dürfen das System nicht verlassen und werden periodisch gelöscht | xx | Sommersemester 2023
|===
