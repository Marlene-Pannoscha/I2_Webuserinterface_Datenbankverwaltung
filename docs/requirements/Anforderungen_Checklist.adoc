...
//ich musste das hier einfügen, sonst funktioniert die Tabelle nicht
=== Mittleres Fenster

[%header, cols="3,1,1"]
|===

//Zeigt Tabelle nicht an
=== Rechtes Fenster
...
//Reiter Fakultät zeigt es nicht an
=== Reiter Fakultät
//Reiter Fakultät
...
zurücksetzen|/ |Mentoren: Mentor suchen größer, Filtern nach Fakultät, Mentor im Detail: Fakultät stimmt
nicht überein |===
