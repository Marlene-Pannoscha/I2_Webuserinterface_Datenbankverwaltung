...
* <<_uc2_logout>>
* <<_uc3_bearbeiten_anlegen_löschen von Fakultäten>> (geplant)
* <<_uc4_verwalten_von_ansprechpersonen>> (geplant)
* <<_uc5_anlegen_neuer_vertrtäge>> (geplant)
* <<_uc6_anlegen_neuer_universitäten>> (geplant)
* <<_uc7_erzeugen_von_berichten>> (geplant)
* <<_uc8_löschen_von_datensätzen>> (geplant)
